# Change Losscut Price

Changes the margin liquidation of the specified position. Target: Margin trading
...
The response contains a standard status code and timestamp.
