...
- [Opening New Accounts](https://api.coin.z.com/docs/en/?rust#open-account)
- [Creating API Keys](https://api.coin.z.com/docs/en/?rust#api-key)
- [Authentication](https://api.coin.z.com/docs/en/?rust#authentication)- [Private API](https://api.coin.z.com/docs/en/?rust#authentication-private)
- [Private WebSocket API](https://api.coin.z.com/docs/en/?rust#authentication-private-ws)

- [Public API](https://api.coin.z.com/docs/en/?rust#public-api)- [Service Status](https://api.coin.z.com/docs/en/?rust#status)
- [Ticker](https://api.coin.z.com/docs/en/?rust#ticker)
- [Order Books](https://api.coin.z.com/docs/en/?rust#orderbooks)
- [Trade History](https://api.coin.z.com/docs/en/?rust#trades)
- [KLine Data](https://api.coin.z.com/docs/en/?rust#klines)
- [Trade rules](https://api.coin.z.com/docs/en/?rust#symbols)

- [Public WebSocket API](https://api.coin.z.com/docs/en/?rust#public-ws-api)- [Ticker](https://api.coin.z.com/docs/en/?rust#ws-ticker)
- [Order Books](https://api.coin.z.com/docs/en/?rust#ws-orderbooks)
- [Trades](https://api.coin.z.com/docs/en/?rust#ws-trades)

- [Private API](https://api.coin.z.com/docs/en/?rust#private-api)- [Margin](https://api.coin.z.com/docs/en/?rust#margin)
- [Assets](https://api.coin.z.com/docs/en/?rust#assets)
- [Trading Volume](https://api.coin.z.com/docs/en/?rust#tradingVolume)
- [Fiat deposit history](https://api.coin.z.com/docs/en/?rust#fiatDepositHistory)
- [Fiat withdrawal history](https://api.coin.z.com/docs/en/?rust#fiatWithdrawalHistory)
- [CryptoCurrency deposit history](https://api.coin.z.com/docs/en/?rust#depositHistory)
- [CryptoCurrency withdrawal history](https://api.coin.z.com/docs/en/?rust#withdrawalHistory)
- [Orders](https://api.coin.z.com/docs/en/?rust#orders)
- [Active Orders](https://api.coin.z.com/docs/en/?rust#active-orders)
- [Executions](https://api.coin.z.com/docs/en/?rust#executions)
- [Latest Executions](https://api.coin.z.com/docs/en/?rust#latest-executions)
- [Open Positions](https://api.coin.z.com/docs/en/?rust#open-positions)
- [Position Summary](https://api.coin.z.com/docs/en/?rust#position-summary)
- [Transfer](https://api.coin.z.com/docs/en/?rust#transfer)
- [Order](https://api.coin.z.com/docs/en/?rust#order)
- [Change Order](https://api.coin.z.com/docs/en/?rust#change-order)
- [Cancel Order](https://api.coin.z.com/docs/en/?rust#cancel-order)
- [Cancel Orders](https://api.coin.z.com/docs/en/?rust#cancel-orders)
- [Cancel Bulk Order](https://api.coin.z.com/docs/en/?rust#cancel-bulk-order)
- [Close Order](https://api.coin.z.com/docs/en/?rust#close-order)
- [Close Bulk Order](https://api.coin.z.com/docs/en/?rust#close-bulk-order)
- [Change Margin Liquidation](https://api.coin.z.com/docs/en/?rust#change-losscut-price)

- [Private WebSocket API](https://api.coin.z.com/docs/en/?rust#private-ws-api)- [Create Access Token](https://api.coin.z.com/docs/en/?rust#ws-auth-post)
- [Extend Access Token](https://api.coin.z.com/docs/en/?rust#ws-auth-put)
- [Delete Access Token](https://api.coin.z.com/docs/en/?rust#ws-auth-delete)
- [Execution Notifications](https://api.coin.z.com/docs/en/?rust#ws-execution-events)
- [Order Notifications](https://api.coin.z.com/docs/en/?rust#ws-order-events)
- [Position Notifications](https://api.coin.z.com/docs/en/?rust#ws-position-events)
- [Position Summary Notifications](https://api.coin.z.com/docs/en/?rust#ws-position-summary-events)

- [Historical Data](https://api.coin.z.com/docs/en/?rust#historical_data)
- [References](https://api.coin.z.com/docs/en/?rust#references)- [Parameters](https://api.coin.z.com/docs/en/?rust#parameters-ref)- [](https://api.coin.z.com/docs/en/?rust#t-spot_param_list_symbol)
- [](https://api.coin.z.com/docs/en/?rust#Margin-parameters-ref)
- [](https://api.coin.z.com/docs/en/?rust#Asset-parameters-ref)

- [Symbols for which SOK(Post-Only) can be specified in the timeInForce parameter](https://api.coin.z.com/docs/en/?rust#sok-ref)
- [HTTP Status Codes](https://api.coin.z.com/docs/en/?rust#http-status-code)
- [Status Codes](https://api.coin.z.com/docs/en/?rust#status-code)
- [Error Codes](https://api.coin.z.com/docs/en/?rust#error-code)

- [Feedback](https://api.coin.z.com/docs/en/?rust#feedback)
- [Changelog](https://api.coin.z.com/docs/en/?rust#changelogs)- [2025](https://api.coin.z.com/docs/en/?rust#2025)- [2025-10-04New](https://api.coin.z.com/docs/en/?rust#2025-10-04-new)
- [2025-08-02New](https://api.coin.z.com/docs/en/?rust#2025-08-02-new)
- [2025-06-28](https://api.coin.z.com/docs/en/?rust#2025-06-28)

- [2024](https://api.coin.z.com/docs/en/?rust#2024)- [2024-12-13](https://api.coin.z.com/docs/en/?rust#2024-12-13)
- [2024-11-02](https://api.coin.z.com/docs/en/?rust#2024-11-02)
- [2024-06-01](https://api.coin.z.com/docs/en/?rust#2024-06-01)
- [2024-04-13](https://api.coin.z.com/docs/en/?rust#2024-04-13)
- [2024-03-02](https://api.coin.z.com/docs/en/?rust#2024-03-02)

- [2023](https://api.coin.z.com/docs/en/?rust#2023)- [2023-12-16](https://api.coin.z.com/docs/en/?rust#2023-12-16)
- [2023-12-09](https://api.coin.z.com/docs/en/?rust#2023-12-09)
- [2023-10-28](https://api.coin.z.com/docs/en/?rust#2023-10-28)
- [2023-10-21](https://api.coin.z.com/docs/en/?rust#2023-10-21)
- [2023-09-16](https://api.coin.z.com/docs/en/?rust#2023-09-16)
- [2023-08-05](https://api.coin.z.com/docs/en/?rust#2023-08-05)
- [2023-07-29](https://api.coin.z.com/docs/en/?rust#2023-07-29)
- [2023-07-08](https://api.coin.z.com/docs/en/?rust#2023-07-08)
- [2023-05-13](https://api.coin.z.com/docs/en/?rust#2023-05-13)
- [2023-03-22](https://api.coin.z.com/docs/en/?rust#2023-03-22)
- [2023-01-18](https://api.coin.z.com/docs/en/?rust#2023-01-18)

- [2022](https://api.coin.z.com/docs/en/?rust#2022)- [2022-12-21](https://api.coin.z.com/docs/en/?rust#2022-12-21)
- [2022-10-12](https://api.coin.z.com/docs/en/?rust#2022-10-12)
- [2022-07-13](https://api.coin.z.com/docs/en/?rust#2022-07-13)
- [2022-07-06](https://api.coin.z.com/docs/en/?rust#2022-07-06)
- [2022-06-08](https://api.coin.z.com/docs/en/?rust#2022-06-08)
- [2022-05-18](https://api.coin.z.com/docs/en/?rust#2022-05-18)
- [2022-04-08](https://api.coin.z.com/docs/en/?rust#2022-04-08)
- [2022-03-30](https://api.coin.z.com/docs/en/?rust#2022-03-30)
- [2022-03-02](https://api.coin.z.com/docs/en/?rust#2022-03-02)
- [2022-02-16](https://api.coin.z.com/docs/en/?rust#2022-02-16)
- [2019-05-29](https://api.coin.z.com/docs/en/?rust#2019-05-29)

- [日本語](https://api.coin.z.com/docs/)
...
Current version:`v1`## API Limiting

API usage Limits are below:##### Public WebSocket API Limiting
...
You can download the historical data (.CSV file)[here](https://api.coin.z.com/data/trades/).# References

This section explains about codes, which are API parameters and response values.## Parameters

This section explains about parameters and their details.###
symbol: Trading symbol| Value | Description | Release date |
| --- | --- | --- |
...
Added: NOT A HOTEL COIN (Spot trading)- Added a new[symbol]():[NAC]()to the Parameter and Response section.
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[NAC]()to the Response section.

### 2024-11-02

[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[AVAX]()to the Response section.
...
Added: Astar (Spot trading)- Added a new[symbol]():[ASTR]()to the Parameter and Response section.
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[ASTR]()to the Response section.

### 2023-01-18

[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[FLR]()to the Response section.

## 2022

### 2022-12-21

Added: New[Trade rules](https://api.coin.z.com/docs/en/?rust#symbols)has been released.### 2022-10-12

[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[SOL]()to the Response section.
...
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[DOGE]()to the Response section.
...
Added: FCR Coin (Spot trading)- Added a new[symbol]():[FCR]()to the Parameter and Response section.
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[FCR]()to the Response section.
...
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[LINK]()to the Response section.

### 2022-02-16

[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[MKR]()[DAI]()to the Response section.
...
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[ADA]()to the Response section.

## 2021

### 2021-12-01

Added: Monacoin (Spot trading)- Added a new[symbol]():[MONA]()to the Parameter and Response section.

### 2021-10-20

Added: Symbol (Spot trading)- Added a new[symbol]():[XYM]()to the Parameter and Response section.
...
Added: Stellar (Spot trading)- Added a new[symbol]():[XLM]()to the Parameter and Response section.

### 2021-08-04

[Position Summary](https://api.coin.z.com/docs/en/?rust#position-summary)- Changed a[symbol]()parameter to Optional.

### 2021-07-14

[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[ATOM]()to the Response section.

### 2021-06-23

Added: NEM (Spot trading)- Added a new[symbol]():[XEM]()to the Parameter and Response section.
...
[Assets](https://api.coin.z.com/docs/en/?rust#assets)- Added a new[symbol]():[DOT]()to the Response section.
...
Added: New[KLine Data](https://api.coin.z.com/docs/en/?rust#klines)has been released.### 2021-03-10

[Margin](https://api.coin.z.com/docs/en/?rust#margin)- Added a new response property:marginRatio
...
[Order](https://api.coin.z.com/docs/en/?rust#order)- Added a new Order parameter:cancelBefore
[Close Order](https://api.coin.z.com/docs/en/?rust#close-order)- Added a new Order parameter:cancelBefore
...
[Order](https://api.coin.z.com/docs/en/?rust#order)- Added a new Order parameter:losscutPrice
...
[Trades (Public WebSocket API)](https://api.coin.z.com/docs/en/?rust#ws-trades)- Added a new Trade parameter:option
